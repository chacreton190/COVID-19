...
RUN;
QUIT;
proc import out = tte datafile="C:\Users\chacr\OneDrive\Documents\Coding\JHU Data\COVID-19\Modified Data Sets\Final COVID Data Set (Through 2020-10-21) (ver2).xlsx"
dbms=xlsx replace;
getnames=Yes;
datarow=2;
run;
